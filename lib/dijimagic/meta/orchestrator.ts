/* ──────────────────────────────────────────────────────────
   DijiAlgoritma — Meta Orchestrator (v1)
   ...
   - objectiveSpec tek doğruluk kaynağıdır (DijiAlgoritma duplicate etmez).
   ────────────────────────────────────────────────────────── */
...
export interface OrchestratorInput {
  ...
  /** Yayın durumu. DijiAlgoritma "Yayınla" → 'ACTIVE' (kullanıcı onayıyla CANLI yayın).
...
export async function orchestrateMetaCreate(
  ...
  // Yayın durumu: DijiAlgoritma "Yayınla" CANLI ister (ACTIVE); diğer çağıranlar PAUSED (varsayılan).

...
import type {
  ...
  AISummary,
  Platform,
} from '@/lib/dijimagic/analysisTypes'
...
/* ──────────────────────────────────────────────────────────
   ...
   (dijimagic_daily_runs.command_center_data için).
...
export function buildDeepAnalysisFromAi(args: {
  ...
  return {
    ...
    actions,
    drafts: [],  // approval workflow ayrı yazılır (mevcut dijimagic_pending_approvals)
    structuralIssues: [],
...
/* dijimagic_daily_runs.command_center_data'ya yaz */

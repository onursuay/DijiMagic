/* ──────────────────────────────────────────────────────────
   DijiAlgoritma — Per-Ad Improvement Prompt (Faz 2)
...
export const PER_AD_SYSTEM_PROMPT = `Sen DijiAlgoritma'nın AI motorusun — TEK bir reklamı analiz edip o reklama özel iyileştirilmiş bir versiyon öneren bir uzmansın.

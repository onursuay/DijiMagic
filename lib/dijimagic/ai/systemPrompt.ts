/* ──────────────────────────────────────────────────────────
   DijiAlgoritma AI Engine — System Prompt (Single-Pass / Batch)
...
export const AI_ENGINE_SYSTEM_PROMPT = `Sen DijiAlgoritma'nın AI motorusun — dijital reklam hesaplarını analiz eden, gerçek veri-driven öneriler üreten bir uzmansın.

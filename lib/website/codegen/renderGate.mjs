...
// sanitize-html (CommonJS) — STATİK default import. Next.js file-tracing bunu
// lambda'ya dahil edebilsin diye: dinamik createRequire('sanitize-html') tracer'a
// GÖRÜNMEZ → Vercel lambda'da "Cannot find module 'sanitize-html'" → route modülü
// init'te çöker → 500 HTML → istemci "Site oluşturulamadı." (KÖK NEDEN bu idi).

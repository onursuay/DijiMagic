...
export const SAFE_ATTRS = {
  ...
  // submits declaratively via data-yoai-form + data-yoai-form-action (set by the
  // serving layer). Only safe layout/aria + the two declarative hooks.
  form: ['class', 'id', 'style', 'data-yoai-form', 'data-yoai-form-action',

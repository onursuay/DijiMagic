/**
 * lib/website/codegen/htmlGenerate.mjs
 *
...
- Generous, intentional whitespace and a clear typographic hierarchy. Large display headings, confident section rhythm.
...
- Mobile nav: a hamburger <button> with data-yoai-nav-toggle="mobile-nav" and aria-controls/aria-expanded="false"; the target menu element has id="mobile-nav" hidden by default. The runtime toggles is-open + the hidden attribute.
- In-page anchor links use <a data-yoai-smooth href="#sectionId"> for smooth scroll; give each target section a matching id.

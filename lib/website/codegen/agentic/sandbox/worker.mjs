 ...
 *   3. Wall-clock watchdog: abort after 8 minutes
...
// ---------------------------------------------------------------------------
// Wall-clock watchdog (8 minutes)
// ---------------------------------------------------------------------------
const ac = new AbortController()
const watchdogMs = 18 * 60 * 1_000
const killer = setTimeout(() => {
  console.warn('[worker] WATCHDOG: 8 minute wall-clock limit reached — aborting')
  ac.abort()
}, watchdogMs)

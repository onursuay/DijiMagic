...
- **Dosyalar:** `app/api/yoai/improvements/hierarchy/route.ts`, `components/yoai/hierarchy/AdsetCard.tsx`, `components/yoai/hierarchy/HierCardActions.tsx`, `components/yoai/hierarchy/DrilldownModal.tsx`, `lib/account/registeredAccounts.ts`

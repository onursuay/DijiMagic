# DijiAlgoritma — Proje Amacı ve İş Kuralları

> Bu doküman DijiAlgoritma modülünün **amacını ve değişmez iş kurallarını** tanımlar.
...
> İlgili dokümanlar: [dijialgoritma_context_audit.md](dijialgoritma_context_audit.md), [DIJIALGORITMA_MERKEZI_ARCHITECTURE.md](DIJIALGORITMA_MERKEZI_ARCHITECTURE.md), [resmi_dokumanlar_index.md](resmi_dokumanlar_index.md)

---

## 1. Sistem Amacı

DijiAlgoritma, DIJIMAGIC içinde, kullanıcının bağlı **Meta + Google reklam hesaplarını** AI ile **periyodik olarak tarayan** ve aşağıdaki çıktıları üreten bir modüldür:
...
> Bu maddelerin mevcut implementasyondaki uyum durumu için bkz. [dijialgoritma_context_audit.md](dijialgoritma_context_audit.md).

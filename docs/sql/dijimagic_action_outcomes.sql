-- ─────────────────────────────────────────────────────────────
-- DijiAlgoritma — Learning Layer v1 (veri biriktirme tablosu)
--
-- Supabase üzerinde aşağıdaki şemayı oluşturun.
-- Bu tablo DijiAlgoritma'nın önerileri ve kullanıcının uyguladığı
-- aksiyonları izler. v1'de sadece kayıt tutulur;
-- outcome analizi v2'de eklenecek.
--
-- Kullanıcı bu tabloyu oluşturmazsa lib/dijimagic/learningStore

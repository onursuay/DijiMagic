...
CREATE INDEX IF NOT EXISTS idx_dijimagic_daily_runs_user_date
  ON dijimagic_daily_runs (user_id, run_date DESC);

CREATE INDEX IF NOT EXISTS idx_dijimagic_daily_runs_user_status
  ON dijimagic_daily_runs (user_id, status, run_date DESC);

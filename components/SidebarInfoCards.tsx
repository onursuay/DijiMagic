...
const featureCards: FeatureCard[] = [
  ...
  },
  {
    ...
    tr: { title: 'DijiMagic Asistan', summary: 'Reklam performansınız hakkında soru sorun, anında yanıt alın. AI asistanınız 7/24 yanınızda.' },
    en: { title: 'DijiMagic Assistant', summary: 'Ask questions about your ad performance and get instant answers. Your AI assistant is available 24/7.' },

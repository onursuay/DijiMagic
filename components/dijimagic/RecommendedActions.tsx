...
import type { DeepAction } from '@/lib/dijimagic/analysisTypes'
import type { ExecutableAction, ActionType } from '@/lib/dijimagic/actionTypes'
...
// Action category keys (translated at render time via dashboard.dijimagic.recommendedActions.category.*)
...
export default function RecommendedActions({ actions, loading, onExecuteAction }: Props) {
  const t = useTranslations('dashboard.dijimagic.recommendedActions')

...
import type { UserAdProfile, CompetitorAd, CompetitorGap, CompetitorComparison } from '@/lib/dijimagic/competitorAnalyzer'
...
export default function CompetitorDashboard() {
  const t = useTranslations('dashboard.dijimagic.competitor')
  ...
  useEffect(() => {
    ...
    fetch('/api/dijimagic/competitors/google-auction')
      .then(r => r.json())
      .then(json => {
    ...
    // Try cache
    try {
      const cached = sessionStorage.getItem('dijimagic_competitor_v2')
      if (cached) {
    ...
    fetch('/api/dijimagic/competitors/analyze')
      .then(r => r.json())
      .then(json => {

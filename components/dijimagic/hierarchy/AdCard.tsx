...
import { translateEnum, translateEnumList } from '@/lib/dijimagic/translations'
import type { AdImprovementRow, AdImprovementOutcome } from '@/lib/dijimagic/ai/hierarchicalStore'
import type { AdSpec } from '@/lib/dijimagic/ai/types'

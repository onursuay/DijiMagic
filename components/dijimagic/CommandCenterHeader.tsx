...
interface Props {
  ...
  onCreateAd?: () => void
  /**
   * Faz 0D: gerçek dijimagic_pending_approvals.status='pending' count.
...
export default function CommandCenterHeader({
  ...
  const t = useTranslations('dashboard.dijimagic.commandCenter')
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center justify-between mb-1">
          <div className="flex items-center gap-3">
            <div className="dijimagic-icon-glow w-9 h-9 rounded-xl bg-primary/20 flex items-center justify-center relative overflow-hidden">

...
export default function TrustStats({ isEn }: { isEn: boolean }) {
  ...
  return (
    <section id="entegrasyonlar" className="relative w-full px-6 py-8 md:py-10 border-y border-white/[0.05] bg-white/[0.012]">

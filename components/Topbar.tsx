...
interface TopbarProps {
  ...
  showTicker?: boolean
  /**
   * Page-supplied account switcher (e.g. Google Ads dropdown). Rendered in the
   * topbar's right cluster, before the Meta section. Lets each page own its
   * platform-specific switcher UI while reusing the topbar layout.
   */
  accountSwitcherSlot?: ReactNode
}
    ...
    <div className="bg-white border-b border-gray-200 px-6 py-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          {/* 1. Page-supplied account switcher (e.g. Google Ads dropdown) */}
          {accountSwitcherSlot}

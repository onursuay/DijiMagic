...
/* ────────────────────────────────────────────────────────────
   DijiAlgoritma İşletme Scope (Faz 3.4 — per-account)
   Seçili işletmeyi (Meta + Google çifti) dijimagic_business_scope cookie'sinde tutar.
   ...
   `DIJIMAGIC_PER_ACCOUNT_SCOPE` kapalıyken pasif (403).
   ──────────────────────────────────────────────────────────── */

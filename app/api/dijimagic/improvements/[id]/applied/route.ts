...
import { getImprovementById, markImprovementApplied, markImprovementPublishError } from '@/lib/dijimagic/ai/improvementStore'

export const dynamic = 'force-dynamic'
export const maxDuration = 15

/**
 * POST /api/dijimagic/improvements/[id]/applied

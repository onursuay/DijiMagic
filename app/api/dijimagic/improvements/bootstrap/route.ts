...
import { getImprovementHierarchy } from '@/lib/dijimagic/ai/hierarchicalStore'
...
/**
 * POST /api/dijimagic/improvements/bootstrap
 *
...
export async function POST() {
  try {
    ...
    const scope = isPerAccountScopeEnabled() ? await resolveDijiMagicScope() : undefined
    ...
    await inngest.send({
      name: 'dijialgoritma/campaign-improvements.user',
      data: { userId, scope },
    })

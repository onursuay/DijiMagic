import { INTENT_DETECTION_PROMPT } from '@/lib/dijimagic/prompts'
import type { ContentCategory } from '@/lib/dijimagic/types'
...
export async function POST(req: Request) {
  try {
    ...
    if (text == null) {
      console.error('[DijiMagic Intent] Claude error')
    ...
    console.error('[DijiMagic Intent] Unexpected error:', err)

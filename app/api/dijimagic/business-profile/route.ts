...
} from '@/lib/dijimagic/businessProfileStore'
import { scanBusinessSources, type SourceScanInput, type SourceType } from '@/lib/dijimagic/businessSourceScanner'
...
export async function GET() {
  try {
    ...
    const scope = isPerAccountScopeEnabled() ? await resolveDijiMagicScope() : null

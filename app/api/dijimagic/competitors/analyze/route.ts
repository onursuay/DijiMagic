...
} from '@/lib/dijimagic/competitorAdStore'
import {
  generateCompetitorInsightFromAds,
  upsertCompetitorInsight,
} from '@/lib/dijimagic/competitorInsightStore'

export const dynamic = 'force-dynamic'

/* ────────────────────────────────────────────────────────────
   GET /api/dijimagic/competitors/analyze
   ...
   Faz 2 (additive):
   - Bulunan rakip reklamlar dijimagic_competitor_ads tablosuna upsert.
   - Deterministik içgörü dijimagic_competitor_insights'a yazılır.

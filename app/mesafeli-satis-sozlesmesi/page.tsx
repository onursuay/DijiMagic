...
export default async function MesafeliSatisSozlesmesiPage() {
  ...
  const c = isEn
    ? {
        ...
        sections: [
          { h: '1. Parties', body: <><strong>Seller:</strong> DijiMagic (Onur Şuay — sole proprietorship), İlkbahar Mah. 621 Sk. No: 24, Çankaya / Ankara 06550, Turkey. info@dijimagic.com, dijimagic.com.<br /><strong>Buyer (Consumer):</strong> The natural/legal person who subscribes to the service and creates an account. The Buyer’s details are those provided during registration and payment.</> },
    ...
    : {
        ...
        sections: [
          { h: '1. Taraflar', body: <><strong>Satıcı:</strong> DijiMagic (Onur Şuay — şahıs işletmesi), İlkbahar Mah. 621 Sk. No: 24, Çankaya / Ankara 06550. info@dijimagic.com, dijimagic.com.<br /><strong>Alıcı (Tüketici):</strong> Hizmete abone olan ve hesap oluşturan gerçek/tüzel kişi. Alıcının bilgileri kayıt ve ödeme sırasında verdiği bilgilerdir.</> },

...
export default async function MesafeliSatisSozlesmesiPage() {
  ...
  const c = isEn
    ? {
        ...
        sections: [
          { h: '1. Parties', body: <><strong>Seller:</strong> YO Dijital Medya Anonim Şirketi (info@yodijital.com, yoai.yodijital.com).<br /><strong>Buyer (Consumer):</strong> The natural/legal person who subscribes to the service and creates an account. The Buyer’s details are those provided during registration and payment.</> },
          { h: '2. Subject of the Agreement', body: 'The subject of this agreement is to determine the rights and obligations of the parties regarding the provision of the YoAi subscription service ordered electronically by the Buyer via yoai.yodijital.com, the characteristics and sale price of which are stated below. The Pre-Information Form is an integral part of this agreement.' },
          { h: '3. Service and Price', body: 'The service is subscription-based access to the YoAi software platform. The selected plan, subscription period (monthly/yearly), number of ad accounts and total price are shown on the payment screen and order summary. The price is collected in Turkish Lira at the prevailing exchange rate at the time of payment.' },
          { h: '4. Payment and Performance', body: 'Payment is collected via the iyzico payment infrastructure from a credit/debit card with 3D Secure. Upon approval of the payment, service access is provided immediately in electronic form. No charge is made during the 14-day free trial.' },
    ...
    : {
        ...
        sections: [
          { h: '1. Taraflar', body: <><strong>Satıcı:</strong> YO Dijital Medya Anonim Şirketi (info@yodijital.com, yoai.yodijital.com).<br /><strong>Alıcı (Tüketici):</strong> Hizmete abone olan ve hesap oluşturan gerçek/tüzel kişi. Alıcının bilgileri kayıt ve ödeme sırasında verdiği bilgilerdir.</> },
          { h: '2. Sözleşmenin Konusu', body: 'İşbu sözleşmenin konusu, Alıcının yoai.yodijital.com üzerinden elektronik ortamda siparişini verdiği, nitelikleri ve satış bedeli aşağıda belirtilen YoAi abonelik hizmetinin sunulmasına ilişkin tarafların hak ve yükümlülüklerinin belirlenmesidir. Ön Bilgilendirme Formu bu sözleşmenin ayrılmaz parçasıdır.' },
          { h: '3. Hizmet ve Bedel', body: 'Hizmet, YoAi yazılım platformuna abonelik tabanlı erişimdir. Seçilen plan, abonelik dönemi (aylık/yıllık), reklam hesabı sayısı ve toplam bedel ödeme ekranında ve sipariş özetinde gösterilir. Bedel, ödeme anında yürürlükteki kur ile Türk Lirası olarak tahsil edilir.' },
          { h: '4. Ödeme ve İfa', body: 'Ödeme, iyzico ödeme altyapısı ile kredi/banka kartından 3D Secure ile tahsil edilir. Ödemenin onaylanmasının ardından hizmet erişimi elektronik ortamda derhal sağlanır. 14 günlük ücretsiz deneme süresince ücret tahsil edilmez.' },

...
export default async function OnBilgilendirmeFormuPage() {
  ...
  const c = isEn
    ? {
        ...
        sections: [
          { h: '1. Seller Information', body: <>Title: DijiMagic (Onur Şuay — sole proprietorship)<br />Service: DijiMagic — AI-powered digital advertising and marketing management platform (dijimagic.com)<br />Email: info@dijimagic.com<br />Address: İlkbahar Mah. 621 Sk. No: 24, Çankaya / Ankara 06550, Turkey<br />Tax Office / No: [To be added]</> },
    ...
    : {
        ...
        sections: [
          { h: '1. Satıcı Bilgileri', body: <>Unvan: DijiMagic (Onur Şuay — şahıs işletmesi)<br />Hizmet: DijiMagic — yapay zeka destekli dijital reklam ve pazarlama yönetim platformu (dijimagic.com)<br />E-posta: info@dijimagic.com<br />Adres: İlkbahar Mah. 621 Sk. No: 24, Çankaya / Ankara 06550<br />Vergi Dairesi / No: [Eklenecek]</> },

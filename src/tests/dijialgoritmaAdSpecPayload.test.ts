/**
 * DijiAlgoritma — Ad Spec Payload (A5) Tests + Örnek Çıktı Raporu
 *
 * Çalıştırma:
 *   npx tsx src/tests/dijialgoritmaAdSpecPayload.test.ts
 *
...
import { validateAdSpecPayload } from '../../lib/dijimagic/ai/adSpecPayload'
import type { AdSpecPayload } from '../../lib/dijimagic/ai/types'
...
async function runAll(): Promise<void> {
  console.log('\nDijiAlgoritma Ad Spec Payload (A5) testleri:\n')

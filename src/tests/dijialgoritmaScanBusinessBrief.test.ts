/**
 * DijiAlgoritma — Scan Business Brief (A1) Tests + Smoke Report
 *
 * Çalıştırma:
 *   npx tsx src/tests/dijialgoritmaScanBusinessBrief.test.ts
 *
...
import { buildScanBusinessBrief } from '../../lib/dijimagic/ai/scanBusinessBrief'
import type { BusinessContext } from '../../lib/dijimagic/businessContextStore'
import { buildUserBrief } from '../../lib/dijimagic/ai/systemPrompt'
...
async function runAll(): Promise<void> {
  console.log('\nDijiAlgoritma Scan Business Brief (A1) testleri:\n')

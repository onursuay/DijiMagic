/**
 * DijiAlgoritma — Platform Reklam Kuralları (A2) Tests
 *
 * Çalıştırma:
 *   npx tsx src/tests/dijialgoritmaPlatformRules.test.ts
 *
...
import { META_AD_RULES_CURATED } from '../../lib/dijimagic/ai/docs/meta_ad_rules_curated'
import { GOOGLE_ADS_RULES_CURATED } from '../../lib/dijimagic/ai/docs/google_ads_rules_curated'
...
async function runAll(): Promise<void> {
  console.log('\nDijiAlgoritma Platform Kuralları (A2) testleri:\n')

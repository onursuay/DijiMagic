/**
 * DijiAlgoritma — Competitor Ads Brief (A4) Tests
 *
 * Çalıştırma:
 *   npx tsx src/tests/dijialgoritmaCompetitorBrief.test.ts
 *
...
} from '../../lib/dijimagic/ai/competitorBrief'
...
async function runAll(): Promise<void> {
  console.log('\nDijiAlgoritma Competitor Brief (A4) testleri:\n')

 ...
 * runtime (yoai-site-runtime.js) is unaffected — this is additive and isolated.
 *
 * BEHAVIOR
...
(function () {
  ...
  function blockFrom(node) {
    ...
    try {
      return node.closest('[data-yoai-block][data-yoai-id]');
    } catch (e) {
      return null;
    }
  }
  ...
  function init() {
    try {
      ...
      document.documentElement.classList.add('yoai-edit');
